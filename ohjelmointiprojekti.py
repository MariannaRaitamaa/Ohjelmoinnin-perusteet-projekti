...
while True:
  print("1 - Päiväkirja, 2 - Ystäväsivu, 3 - Osoitekirja, 4 - Lopeta") # Päävalikko
  ...
  if toiminto == "1":  # Päiväkirja
    with open("paivakirja.txt", "a+") as tiedosto:
      ...
      while True:
        ...
        if toiminto2 == "1":
          ...
          paivakirjateksti.append(merkinta) # Tallenna merkintä listaan
        ...
        # Jos päivämäärällä ei löytynyt merkintöjä, tulostuu seuraava
          ...
          print("Virheellinen valinta, syötä 1, 2 tai 3.") # Virheilmoitus
    ...
    with open("ystavasivu.txt", "a+") as tiedosto:
      ...
      while True:
        ...
        if toiminto2 == "1":
          ...
          ystavasivuteksti.append(merkinta.strip()) # Tallenna merkintä listaan

          print("Ystävän tiedot tallennettu")
        # Hae merkintä ystävän nimellä
        elif toiminto2 == "2":
          nimi = input("Nimi: ") 
    ...
    while True:
      print("1 - Lisää osoitetiedot, 2 - Hae osoitetiedot, 3 - Alkuun") # Alavalikko
      toiminto2 = input("Valitse toiminto: ")
      ...
      if toiminto2 == "1":
        ...
        with open("osoitekirja.txt", "a") as tiedosto:
          tiedosto.write(merkinta)
        osoitekirjatiedot.append(merkinta.strip()) # Tallenna merkintä listaan

        print("Osoitetiedot tallennettu")
        # Hae osoitetiedot etunimen perusteella
      elif toiminto2 == "2":
        etunimi = input("Etunimi: ")
        ...
        # Jos etunimellä ei löytynyt tietoja, tulostuu seuraava
        else:
